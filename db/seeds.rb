...
l1 = List.create(name: "Great Films")
l2 = List.create(name: "Bad Films")

b1 = Bookmark.create(comment: "Timeless Classic!", movie_id: m2.id, list_id: l1.id)
b2 = Bookmark.create(comment: "Timeless Classic!", movie_id: m3.id, list_id: l1.id)
b3 = Bookmark.create(comment: "Timeless Flop!", movie_id: m1.id, list_id: l2.id)
b4 = Bookmark.create(comment: "Timeless Flop!", movie_id: m4.id, list_id: l2.id)
